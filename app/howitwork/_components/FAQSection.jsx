            ...
            <Grid container spacing={3} justifyContent="center">
              <Grid item xs={12} md={10} lg={8}>
                <Box sx={{ textAlign: 'center', mb: 6 }}>
                  ...
                  <Typography
                    variant="h2" // Using theme typography
                    component="h2"
                    align="center"
                    sx={{ 
                      fontWeight: 700, 
                ...
                {filteredFaqs.length === 0 ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography variant="h5" sx={{ color: theme.palette.primary.dark, mb: 2 }}>
                            ...
                            >
                              ...
                              >
                                <Box sx={{ display: 'flex', alignItems: 'flex-start', flex: 1 }}>
                                  ...
                                  >
                                    {highlightText(faq.question, searchQuery, theme)}
                                  </Typography>
                                </Box>
                                <motion.div
                                ...
                                {expandedPanel === `panel${index}` && (
                                  ...
                                  >
                                    <Box sx={{ mt: 2, ml: 8 }}>
                                      ...
                                      >
                                        {highlightText(faq.answer, searchQuery, theme)}
                                      </Typography>
                                    </Box>
                                  </motion.div>
                                )}
