    ...
    >
      ...
      <Box
        sx={{
          ...
          height: 200,
          borderRadius: '50%',
          background: `linear-gradient(135deg, ${theme.palette.primary.light || '#a5f3ec'} 0%, transparent 70%)`,
          opacity: 0.5,
          zIndex: 0
        }}
      />
              ...
              <Box sx={{ textAlign: 'center', mb: 6 }}>
                <Box
                  sx={{
                    ...
                    height: 80,
                    borderRadius: '50%',
                    backgroundColor: theme.palette.primary.main || '#28ddcd',
                    mb: 3
                  }}
                >
                ...
                <Box
                  ...
                  sx={{
                    ...
                    border: `1px solid ${searchFocus ? theme.palette.primary.main || '#28ddcd' : '#e2e8f0'}`,
                ...
                >
                  ...
                  >
                    ...
                    <Button
                      ...
                      onClick={() => setSearchQuery('')}
                      sx={{
                        borderColor: theme.palette.primary.main || '#28ddcd',
                        color: theme.palette.primary.main || '#28ddcd'
                      }}
                    >
                      Show All FAQs
                    </Button>
                          ...
                          >
                            ...
                            >
                              <Box sx={{ display: 'flex', alignItems: 'flex-start', flex: 1 }}>
                                <Box
                                  sx={{
                                    backgroundColor: getTagColor(faq.category, theme),
                                    color: '#ffffff',
                                    fontSize: '0.75rem',
                                    fontWeight: 600,
                                    px: 1.5,
...
function getTagColor(category, theme) {
  switch (category) {
    case 'Pricing':
      return '#4CAF50'; // Green
    case 'Service':
      return theme.palette.primary.main || '#28ddcd'; // Turquoise
    case 'Policies':
      return '#F44336'; // Red
    case 'Products':
