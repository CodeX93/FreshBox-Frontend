...
class ApiServices {
  ...
  payForOrderStripe(data) {
    return api.post(`/payment/create-payment-session-stripe`,data);
  }
  payForOrderPaypal(data) {
    return api.post(`/payment/create-payment-session-paypal`,data);
  }
  //support
  createSupport(data){
